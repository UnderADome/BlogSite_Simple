...
insert into whisper values(null, now(), 1200, 1200, "　　一直听说牛油果吃起来像肥皂、肥肉，虽然很难吃，但是价格却很贵，我还是想尝试一下。今天公司新到了新西兰牛油果，这是新西兰牛油果是第一次在中国上市，个头比普通牛油果大了一倍，被誉为“超牛果”。好奇心驱使我尝了一颗，第一次吃牛油果没有见识，切开牛油果费了好大劲，切成了这样。", '<img src="res/img/wy_img1.jpg">');
insert into whisper values(null, now(), 12, 100, "　　“意境”是书法艺术所表现的精神境界，即作者以其笔墨技巧，表达对自然界和生活现象的观察、思考、感受，通过作品抒发自己思想、意趣、性灵、情操。意境越高，越能显示美的魅力。只有技术和法度而缺乏意境，称之为“字匠”。凡是造诣极高的书家，无不以意境、神韵为书道之最高目标。", '<img src="res/img/wy_img2.jpg"><img src="res/img/wy_img3.jpg"><img src="res/img/wy_img4.jpg">');
insert into whisper values(null, now(), 430, 251, "　　这些书家作品，充满意境之美，或以驰骋纵横之志，或以抒发郁结之怀，凡“喜怒、窘穷、忧伤、怨恨、思慕、酣醉、无聊、不平、有动于心”，必以书法发之。意境之美是富于深刻内容的美，是建筑于书法法度基础上的美。", '<img src="res/img/wy_img5.jpg">');
insert into whisper values(null, now(), 345, 1465, "　　你是我久久设想 而未落笔的 执着故事的 一个雏形 在一个陌生古城的小巷 叮咚一声 隐约在烟雨。", '<img src="res/img/wy_img1.jpg">');
insert into whisper values(null, now(), 2354, 153, "　　游子的千层底里缝进的是亲情，黄鹤楼上遥望不归的是友情，千里孤坟埋不住的是爱情。敢问世间情为何物？情是人生的灵魂，是人生妙章中最重要的一笔。没有亲情，犹如酷寒的冬季没有结束的日期；没有友情，犹如漂泊不定的小舟没有避风的港湾；没有爱情，犹如黑夜里的寒月没有温暖和光明。", '<img src="res/img/wy_img1.jpg">');
insert into whisper values(null, now(), 145, 333, "　　翻开浩瀚的历史画卷，许多历史人物脱颖而出，向人们诉说着尊严。从在北海牧羊十九年而从未放弃祖国的苏武到“留取丹心照汗青”的文天祥；从“不为五斗米折腰”的陶渊明到“安能摧眉折腰事权贵”的李白；从置生死于不顾、愤怒销毁鸦p的林则徐到巴黎和会上从容不迫、昂首挺胸的顾维钧，他们用尊严描绘着自己的人生。尊严之歌穿越岁月的风尘而历久弥新；尊严之歌趟过历史的长河而亘古不变。", '<img src="res/img/wy_img1.jpg">');
insert into whisper values(null, now(), 222, 111, "　　如果追求是刚发芽的幼苗，那么彩虹便是盛开着朵朵鲜花的枝干。如果追求是一棵翠绿的果树，那么彩虹便是那五颜六色的硕果。如果追求是人生的起点，那么彩虹便是成功的彼岸。相信，成功之花在彩虹的映照下会变得更加绚烂夺目。", '<img src="res/img/wy_img1.jpg">');
insert into whisper values(null, now(), 1200, 1200, "　　生命如画，有浓墨泼洒，也有淡笔轻描；生命如歌，有轻吟浅唱，也有黄钟大吕。君不见李太白、杜工部之一生，浓墨泼洒，铸就生命之伟大；裴多菲、雪莱之一生，淡笔轻描终写尽生命之真谛。君不见轻音浅唱之陶渊明“采菊东篱下，悠然见南山”，高歌猛进之谭嗣同“我自横刀向天笑，去留肝胆两昆仑”。", '<img src="res/img/wy_img1.jpg">');
insert into whisper values(null, now(), 1200, 1200, "　　生命是山，我们无法预估它的长度，我们只好追求它的高度。生命是路，它是由一块块不起眼的沙石组成的，而不是铺金布银，平平淡淡中尽显生命之完美。生命是一叶扁舟，航行于茫茫沧海之中，只有经历暴风雨的洗礼，才会迎来明天海上初升的太阳。", '<img src="res/img/wy_img1.jpg">');
